...
*Potom. Sem odkázalo rozhodnutí [045](./decisions/045-a-conversion-that-produced-nothing-says-so.md), které atribuci po jednotkách vědomě nechalo otevřenou. Souvisí s [010](./decisions/010-diagnostics-as-returned-data.md) a s vícejednotkovým vstupem podle F14. Požadavky F11, F14, S6.*
