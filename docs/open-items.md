...
*Na řadě. Souvisí s rozhodnutími [017](./decisions/017-source-precedence-for-mapping-facts.md), [049](./decisions/049-language-facts-under-source-precedence.md) a [066](./decisions/066-records-attributed-to-the-input-unit.md). Požadavky F5, F11, F14.*
