...
*Navazuje na rozhodnutí [100](./decisions/100-interactive-comparison-as-a-frozen-mockup.md) a přes ně na [099](./decisions/099-examples-are-content-not-a-choice.md) a [033](./decisions/033-shape-of-the-static-frontend-screens.md), odkud pětikrokový tvar obrazovky pochází beze změny; je podle něj napsaný kód, takže případnou změnu je třeba nahradit, ne revidovat. Souvisí s [032](./decisions/032-frontend-as-static-pages-without-a-build.md) a s rozhodnutím [066](./decisions/066-records-attributed-to-the-input-unit.md). Podklad: maketa `comparison.html` (rozhodnutí 100). Požadavky F14, S7.*
...
**Podklad k tomu od 2026-09-23 existuje a dá se osahat:** maketa `comparison.html` (rozhodnutí [100](./decisions/100-interactive-comparison-as-a-frozen-mockup.md)) ukazuje, jak by taková obrazovka vypadala, kdyby původ nesla — a je záměrně o stupeň ambicióznější než tahle položka, protože nepáruje soubory, ale **slova**. Rozhodnutí má proto před sebou i otázku jemnosti: párování po artefaktech je levné a odpovídá na „ze kterého souboru to je", párování po tvrzeních (fakt mapování, klauzule dotazu) odpovídá na „které slovo se stalo kterým slovem" a dotklo by se každého builderu. Maketa je odpověď na to, co by za to druhé bylo vidět; cenu nese rozhodnutí. Dokud nevznikne, zůstávají spoje na té stránce ruční prací a maketa se po jejím naplnění maže.
