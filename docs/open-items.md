...
*Na řadě. Nalezeno při implementaci scénářů 4. stupně pro 1:1 a M:N (2026-08-25, [`architecture.md`](./architecture.md) §6.2). Souvisí s rozhodnutími [012](./decisions/012-foreign-key-rendering.md) a [015](./decisions/015-mapping-fact-completion-from-the-catalog.md) a s položkou „Kritérium pro širší čtení konvencí zdroje". Požadavky F4, F6, F11.*
