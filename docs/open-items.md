...
*Na řadě. Souvisí s rozhodnutím [015](./decisions/015-mapping-fact-completion-from-the-catalog.md) a s [`ORMConvertor/README.md`](../ORMConvertor/README.md#translation-performance-s3). Požadavek S3.*
