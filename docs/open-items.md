...
*Na řadě. Zbytek kritéria F3 po prvních zástupcích 4. stupně (2026-08-24, [`architecture.md`](./architecture.md) §6.2); stupně podle rozhodnutí [016](./decisions/016-generated-artifact-verification-levels.md). Požadavky F3, F4, F6.*
...
*Potom. Vyňatá oblast 4 hranice záruk ([`architecture.md`](./architecture.md), §9). Navazuje na rozhodnutí [022](./decisions/022-native-query-syntax-in-builders.md) a [026](./decisions/026-home-of-shared-query-reading.md). Požadavky F7–F10, T2, T3.*
