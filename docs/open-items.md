...
*Potom. Rozhodnutí k F9; vrstvu, nad kterou stojí, postavilo rozhodnutí [077](./decisions/077-hibernate-wrapper-over-the-shared-jpa-layer.md), takže tahle položka je jen o tom, co je EclipseLink samotné. Podklad: [tutoriál k EclipseLinku](./analysis/tutorials/eclipselink-getting-started.md) a [srovnání javových frameworků](./analysis/java-orm-frameworks-comparison.md), §4, §5, §16 a §20. Požadavky F9, F10, S1, S2.*
