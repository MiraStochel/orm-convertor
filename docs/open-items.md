...
**Položky jsou roztříděné do čtyř kategorií, ne do cílů zadání.** Cíle 1 a 2 jsou hotové a třetí by zbyl jediný, takže dělení podle nich přestalo třídit. Kategorie říká, na čem se pracuje teď — a u zbytku, proč se na něm nepracuje:
