...
**Dapper jako zdroj.** Číst T-SQL znamená mít parser jazyka. Psát ho ručně je práce, která není přínosem téhle práce a snadno spolkne víc času než celá dotazová matice; existuje oficiální parser T-SQL jako samostatný balíček. Otázka je, jestli se takový balíček smí objevit uvnitř wrapperu, když je S1 postavené na tom, že wrappery nezávisejí na frameworku, pro který generují.
