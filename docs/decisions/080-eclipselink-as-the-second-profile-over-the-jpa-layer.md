...
**F9 zůstává vyňaté, dokud javová sada nad EclipseLinkem poprvé neproběhne.** Wrapper existuje, kritérium F9 má v xUnit všechny tři počty a javová polovina je napsaná — ale nikdy neběžela, a zkušenost s rozhodnutím 077 je čerstvá: z jeho dvou tvrzení javová sada jedno vyvrátila a stálo to rozhodnutí 079. Nárok na EclipseLink proto vzniká až po tom běhu; do té chvíle je EclipseLink v repozitáři a v rozhraní, jen na něj verze neslibuje spoleh (§9, oblast 6). Je to táž opatrnost, s jakou do nároku vstupovalo F7.
