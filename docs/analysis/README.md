...
Šest tutoriálů má **záměrně shodnou doménu i číslování kroků**, aby se daly položit vedle sebe a číst po řádcích. Tři javové díly popisují frameworky, které nástroj zatím nepřekládá (F7–F10); je to příprava javové větve, ne popis implementovaného stavu.
