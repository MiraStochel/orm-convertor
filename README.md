...
- **Next: the Java ecosystem.** Hibernate, MyBatis, and EclipseLink, cross-ecosystem translation between .NET and Java, and a Java test infrastructure that verifies query results differentially. The Hibernate wrapper is the first piece in place; the Java test suite that compiles and runs what it generates is what comes next. This is the milestone the next MAJOR is reserved for, and none of it is claimed today.
